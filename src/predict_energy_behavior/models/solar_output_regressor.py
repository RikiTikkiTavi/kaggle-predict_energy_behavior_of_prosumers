...
class SolarOutputRegressor:
    ...
    def predict(self, X: pd.DataFrame) -> np.ndarray:
        ...
        if "C_CC_total_direct" in parameters:
            ...
            I_adj_cc  += regressors["direct_solar_radiation"] * (1 - parameters["C_cloud_direct"] * regressors['cloudcover_high'] / 100)
            # adjusted diffusive irradiance
            I_adj_cc += regressors["diffuse_radiation"] * (1 - parameters["C_cloud_diffusive"] * regressors['cloudcover_low'] / 100)
